...
public class TestUser{
	...
	public void testConstructor() {
		...
		if(check == 1){
			...
			dateOfBirth = new Date(-228528000);
			u1.setId(1);
	...
	public void testEquals(){
		...
		if(check == 1){
			...
			dateOfBirth = new Date(-228528000);
			User u2 = new User(1, Gender.MALE, UserType.ADMIN, "Marc", "De Hertogh", dateOfBirth, true);
			assertEquals(true, u1.equals(u2));
		}
	}
	...
	public void testHashCode(){
		...
		if(check == 1){
			...
			dateOfBirth = new Date(-228528000);
			User u2 = new User(1, Gender.MALE, UserType.CUSTOMER, "Marc", "De Hertogh", dateOfBirth, true);
			assertEquals(u1.hashCode(), u2.hashCode());
		}
	}
