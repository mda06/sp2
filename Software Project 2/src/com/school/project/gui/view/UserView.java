...
public class UserView extends BaseView {
	...
	public void initLayout() {
		...
		FontUtil.getInstance().bindSmallFont(lbFirstName);
		FontUtil.getInstance().bindSmallFont(lbLastName);
		FontUtil.getInstance().bindSmallFont(lbUsername);
		FontUtil.getInstance().bindSmallFont(lbPassword);
		FontUtil.getInstance().bindSmallFont(lbPasswordControl);
		FontUtil.getInstance().bindSmallFont(lbStreetNumber);
		FontUtil.getInstance().bindSmallFont(lbZipcode);
		FontUtil.getInstance().bindSmallFont(lbCity);
		FontUtil.getInstance().bindSmallFont(lblDate);
		FontUtil.getInstance().bindSmallFont(lblGender);
		FontUtil.getInstance().bindSmallFont(lblSoortuser);
		FontUtil.getInstance().bindSmallFont(pfPassword);
		FontUtil.getInstance().bindSmallFont(pfPasswordControl);
		FontUtil.getInstance().bindSmallFont(txtFirstName);
		FontUtil.getInstance().bindSmallFont(txtLastName);
		FontUtil.getInstance().bindSmallFont(txtUsername);
		FontUtil.getInstance().bindSmallFont(txtStreetNumber);
		FontUtil.getInstance().bindSmallFont(txtZipcode);
		FontUtil.getInstance().bindSmallFont(txtCity);
		FontUtil.getInstance().bindSmallFont(btnComplete);
		FontUtil.getInstance().bindSmallFont(btnBack);
		FontUtil.getInstance().bindSmallFont(btnSelectUser);
		FontUtil.getInstance().bindSmallFont(cBUseCredentials);
		FontUtil.getInstance().bindSmallFont(cBGenderM);
