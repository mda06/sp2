...
public class TestRailCard {
	...
	public static RailCard getSecondRailCard(){
		return new RailCard(2, "JOURNEY RAILCARD", "commuters, unlimited travel on your route, emplyer's contribution", 26.00, 73.00, 260.00, true, false);
	}
	...
	public void testEquals(){
		...
		if(check == 1){
			RailCard rc2 = TestRailCard.getFirstRailCard();
